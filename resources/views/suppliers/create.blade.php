            ...
            <div class="form-section">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" name="phone" id="phone" class="form-control-custom @error('phone') is-invalid @enderror" value="{{ old('phone') }}" placeholder="Enter 11-digit phone number" maxlength="11" pattern="[0-9]{11}">
                        @error('phone')
                            <div class="invalid-feedback-custom">
                                <i class="bi bi-exclamation-circle"></i> {{ $message }}
                            </div>
