        ...
        \DB::statement("
            ...
            BEGIN
                ...
                IF constraint_name IS NOT NULL THEN
                    EXECUTE 'ALTER TABLE goods_returns DROP CONSTRAINT ' || quote_ident(constraint_name);
                END IF;
                
                -- Add new check constraint with 'cancelled' option
                ALTER TABLE goods_returns ADD CONSTRAINT goods_returns_status_check 
                CHECK (status IN ('draft', 'pending', 'approved', 'returned', 'cancelled'));
            END \$\$;
        ");
    }
    ...
    public function down(): void
    {
        ...
        \DB::statement("
            ...
            BEGIN
                ...
                ALTER TABLE goods_returns ADD CONSTRAINT goods_returns_status_check 
                CHECK (status IN ('draft', 'pending', 'approved', 'returned'));
            END \$\$;
        ");
    }
};
